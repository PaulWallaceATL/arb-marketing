...
(function ($) {
  ...
  $(function () {
    ...
    /*--------------------------------------------------------------
    AXIMO IMAGE SWIPE HOVER JS INIT - DISABLED
    ------------------------------------------------------------*/

    // Image cursor follow effect disabled - replaced with custom cursor
    /* 
  ...
  customCursor.textContent = 'View Details';
  ...
  /*--------------------------------------------------------------
  DOT GRID EFFECT WITH INERTIA FOR CTA SECTION
  ------------------------------------------------------------*/
  
  const dotGridContainer = document.getElementById('dotGridContainer');
  
  if (dotGridContainer && typeof DotGrid !== 'undefined') {
