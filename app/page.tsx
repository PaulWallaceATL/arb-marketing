...
export default function Home() {
  return (
    <div className="aximo-all-section">
      ...
      {/* Final CTA Section */}
      <div className="aximo-cta-section aximo-section-padding extra-side-margin position-relative" style={{ background: 'linear-gradient(135deg, #DDD6FE 0%, #ffffff 50%, #C4B5FD 100%)', overflow: 'hidden', minHeight: '500px', borderRadius: '20px 20px 0 0' }}>
        <div className="container position-relative">
